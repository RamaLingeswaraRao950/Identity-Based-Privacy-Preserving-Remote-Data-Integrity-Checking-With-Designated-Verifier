        ...
        <div class="article">
          ...
          <div class="img">
            <div align="justify"></div>
						...
						<tr>
						<td width="286" height="35" bgcolor="#CC00FF"><span class="style26 style4">Select File :- </span></td>
						<td width="356"><input required="required" type="file" name="t42" id="file"  onchange="loadFileAsText()" /></td>
						</tr>
						<tr>
						<td height="35" bgcolor="#CC00FF" class="style4 style26">File Name :- </td>
						<td><input required="required" name="tt" type="text" id="t42" size="50"/></td>
						</tr>
						<tr>
						<td height="255" bgcolor="#CC00FF">&nbsp;</td>
						...
						<td><input type="submit" name="Submit" value="Encrypt" /></td>
					       ...
					       <div class="style2"></div>
		 <div align="right"><a href="DO_Main.jsp">Back</a> </div>
        </div>
      </div>
