...
<div class="main">
  <div class="header">
    <div class="header_resize">
      ...
      <div class="logo">
        <h1 class="style3"><a href="index.html" class="style28">Identity-Based Privacy Preserving Remote Data Integrity Checking With a Designated Verifier </a></h1>
      </div>
	   	...
	   	%>
            ...
            <form action="DU_Download1.jsp" method="post" id="form1">
              <table width="473" border="0" align="center">
                ...
                <tr>
                  <td height="34" bgcolor="#FF0000"><span class="style29 style18"><strong>Trapdoor :-</strong></span></td>
