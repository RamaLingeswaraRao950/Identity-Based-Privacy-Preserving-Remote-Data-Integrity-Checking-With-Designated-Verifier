...
<head>
<title>DO_View_Verifier_Results</title>
...
Integrity Checking With a Designated Verifier</a></h1>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>View Verifier Results !!! </span> </h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
            <table width="595" border="1.5" cellpadding="0" cellspacing="0" align="center">
              <tr>
			   <td width="78" height="30" bgcolor="#FF0000"><div align="center" class="style21 style23"><strong>File Name</strong></div></td>
                ...
                <td width="205" bgcolor="#FF0000"><div align="center" class="style24">Verifier Results </div></td>
				<td width="205" bgcolor="#FF0000"><div align="center" class="style24">Verified Date and Time </div></td>
      	...
      	try 
	{
			...
			String skstatus="No";
      		...
      		String query="select * from verifierresults"; 
