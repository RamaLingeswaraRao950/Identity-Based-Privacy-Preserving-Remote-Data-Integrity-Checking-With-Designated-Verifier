...
<head>
<title>KGC Authority Login</title>
...
Integrity Checking With a Designated Verifier
      ...
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="KGC_Login.jsp"><span>KGC</span></a></li>
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span>KGC Authority Login  </span></h2>
          <p class="infopost">&nbsp;</p>
          <div class="clr"></div>
          <div class="article">
            <form action="KGC_Authentication.jsp" method="post" id="leavereply">
              <label for="name"><br />
