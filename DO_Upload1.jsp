...
<input type="hidden" name="fsize" value="<%=sourceFileSize %>" />
  <table width="560" border="0" align="center">
    <tr><input type="hidden" name="start" value="<%=start%>" />
      <td width="143" height="39" bgcolor="#FF0000"><span class="style24 style4"><strong>File Name :- </strong></span></td>
      <td width="407"><input name="t42" type="text" id="t42"
			value="<%= file %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="40" bgcolor="#FF0000"><span class="style24 style4"><strong>Block-1 </strong></span></td>
    ...
    <tr>
      <td height="40" bgcolor="#FF0000"><span class="style24 style4"><strong>Digital Signature -1: </strong></span></td>
      <td><input name="t1" type="text" id="t4"
			value="<%= h[1] %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="41" bgcolor="#FF0000"><span class="style24 style4"><strong>Block-2 </strong></span></td>
      <td width="407"><span class="style4 style22">Size:<%=(a2-a1)%>Bytes</span></td>
    </tr>
    <tr>
      <td bgcolor="#FF0000"><span class="style27">></span></td>
      <td>
        <textarea name="text2" cols="50" rows="8" readonly="readonly"><%= encryptedValue2 %></textarea>      </td>
    </tr>
    <tr>
      <td height="37" bgcolor="#FF0000"><span class="style24 style4"><strong>Digital Signature-2: </strong></span></td>
      <td><input name="t2" type="text" id="t4"
			value="<%= h[2] %>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="40" bgcolor="#FF0000"><span class="style24 style4"><strong>Block-3 </strong></span></td>
    ...
    <tr>
      <td height="41" bgcolor="#FF0000"><span class="style24 style4"><strong>Digital Signature-3: </strong></span></td>
      <td><input name="t3" type="text" id="t4"
			value="<%= h[3]%>" size="50" readonly="readonly" /></td>
    </tr>
    <tr>
      <td width="143" height="35" bgcolor="#FF0000"><span class="style24 style4"><strong>Block-4 </strong></span></td>
    ...
    <tr>
      <td height="42" bgcolor="#FF0000"><span class="style24 style4"><strong>Digital Signature-4: </strong></span></td>
...
<div align="right"><a href="DO_Upload.jsp">Back</a>
    <%
}
