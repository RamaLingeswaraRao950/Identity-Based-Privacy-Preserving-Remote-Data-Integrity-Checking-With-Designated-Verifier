        ...
        <div class="article">
          ...
          <div class="article">
            <table width="595" border="1.5" cellpadding="0" cellspacing="0" align="center">
              <tr>
			   <td width="78" height="30" bgcolor="#FF0000"><div align="center" class="style21 style23"><strong>ID Number </strong></div></td>
                ...
                <td width="205" bgcolor="#FF0000"><div align="center" class="style24">Secret Key </div></td>
                <%	  
	...
	while ( rs.next() )
	   {
		...
		%>
              ...
              <tr>
                <td height="42"><div align="center" class="style26"><%=i%></div></td>
		...
		%>
                <td><div class="style26">
                    <div align="center"><a href="KGC_SKGen1.jsp?usid=<%=i%>&amp;fname=<%=s2%>&amp;owner=<%=s3%>"><%=s4%></a></div>
                </div></td>
                <%
...
%>
            ...
            <p align="justify">&nbsp;</p>
            <p align="right"><a href="KGC_Main.jsp">Back</a></p>
          </div>
          <div class="clr"></div>
        </div>
      </div>
