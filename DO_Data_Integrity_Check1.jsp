...
<%
	String owner=(String)application.getAttribute("doname");
	   ...
	   if ( rs2.next() )
		  ...
		  %>
<h1>  <%=file%>  ---- <%=block %> ---  is Safe</h1><a href="DO_Main.jsp">Back</a></br>

		  <%
		  
		  String type="Safe";
					String strQuery4 = "insert into auditresults(fname,bname,ownername,audittype,dt) values('"+ file+"','"+ block+"','"+owner+"','"+type+"','"+dt+ "')";
		   ...
		   %>
		   <h1> <%=file%>  ---- <%=block %> ---is Not Safe</h1><a href="DO_Main.jsp">Back</a>Do you Want to recover <a href="recover.jsp?owner=<%=owner%>&block=<%=block%>&file=<%=file%>">Recover</a><%
		 //  String ss="attacker";
		  // application.setAttribute("fname",file);
		  //application.setAttribute("attacker",ss);
		   }
		   ...
		   {%>
		   <h1> File doesnot exist</h1><a href="DO_Main.jsp">Back</a><%
		   }
