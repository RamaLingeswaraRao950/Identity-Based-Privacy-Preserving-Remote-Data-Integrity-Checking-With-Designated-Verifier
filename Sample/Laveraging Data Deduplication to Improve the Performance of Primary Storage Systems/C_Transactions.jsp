    ...
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2> Transactions </h2>
          <p class="infopost">&nbsp;</p>
          <p class="infopost"><span class="style4"><span class="style5"><span class="style6">Click Here For <a href="C_MemTransactions.jsp">Memory Transactions</a></span></span></span></p>
