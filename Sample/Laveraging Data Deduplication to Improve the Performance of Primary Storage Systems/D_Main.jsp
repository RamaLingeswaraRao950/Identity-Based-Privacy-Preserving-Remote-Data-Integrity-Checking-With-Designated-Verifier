  ...
  <div class="content style1">
    <div class="content_resize">
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          <h2 class="star"> DDup Menu</h2>
          <div class="style2"></div>
          <ul class="sb_menu">
            <li><strong><a href="D_Main.jsp">Home</a></strong></li>
            <li><strong><a href="D_ViewFiles.jsp">View Files </a></strong></li>
            <li><strong><a href="D_CpuSpeed.jsp">CPU Speed </a></strong></li>
            <li><strong><a href="D_MemSaved.jsp">Saved Memory</a></strong></li>
            <li><strong><a href="D_Ded_up.jsp"> Deduplication Uploaded </a> </strong></li>
            <li><strong><a href="D_S_Dedup.jsp">Send Deduplication </a></strong></li>
            <li><strong><a href="D_Login.jsp">Logout</a></strong></li>
          </ul>
        </div>
      </div>
      <div class="style2"></div>
