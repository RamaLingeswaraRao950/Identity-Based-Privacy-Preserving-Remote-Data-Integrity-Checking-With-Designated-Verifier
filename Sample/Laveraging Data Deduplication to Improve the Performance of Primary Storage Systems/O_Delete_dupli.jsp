  ...
  <div class="content style1">
	...
	try 
	{
		...
		String strQuery12 = "select * from cloudserver where fname='"+file+"'";
			...
			ResultSet rs1=st1.executeQuery(strQuery12);
			if(rs1.next())
			{
				...
				if (rs2.next()==true)
				{
					...
					int fsize1=Integer.parseInt(rs1.getString(15));
					...
					if(rs3==1)
					{
						...
						st5.executeUpdate("delete from deduplication where dfname='"+file+"' and name='"+dname+"'");
			...
			else
			{
				...
				<p>&nbsp;</p>
				<p><a href="DO_Main.jsp">Back</a><a href="DO_Delete.jsp"></a><br />
				<%
			}
	}
	catch(Exception e)
