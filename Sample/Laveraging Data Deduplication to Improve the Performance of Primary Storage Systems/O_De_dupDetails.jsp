...
<div class="main">
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2>Deduplication Log From Deduplicator </h2>
          <p class="infopost">&nbsp;</p>
          <div class="style2"></div>
          <div class="img">
          ...
          <div class="post_content">
            <table width="467" border="1.5" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
              <%	  
...
try 
	{		
				...
				%>
              <tr>
                <td width="31" height="30"><div align="center" class="style21"><span class="style23"> ID </span></div></td>
                <td width="94"><div align="center" class="style21"><span class="style23"> File Name </span></div></td>
                <td width="117"><div align="center" class="style21"><span class="style23"> Orginal File </span></div></td>
                <td width="140"><div align="center" class="style21"><span class="style23"> Action </span></div></td>
              </tr>
              <%
				String dname=(String)application.getAttribute("doname");
				
				String query="Select *from deduplication where name='"+dname+"' "; 
				...
				while ( rs.next() )
				{
					...
					%>
              <tr>
                <td height="62"><div align="center"><%=i%></div></td>
                <td><div align="center"><%=s6%></div></td>
                <td><div align="center"><%=s3%></div></td>
                <td>
				<div align="center">
                  <form id="form1" name="form1" method="post" action="O_Delete_dupli.jsp?fname=<%=s6%>"></form>
				  <form id="form2" name="form1" method="post" action="O_Share_dupli.jsp?dup_f=<%=s6%>&amp;org_f=<%=s3%>"></form>
                     <input type="submit" name="Submit2" value="Delete" form="form1" />
                    <input type="submit" name="Submit" value="Share" form="form2" />
                </div>                </td>
            <%
				}
	connection.close();
