...
<div class="main">
  ...
  <div class="content style1">
	...
	{			
		...
		String query2="select * from cloudpurchase where downer='"+dname+"'  "; 
		...
		{	
			...
			String slafrom=rs2.getString(10);	
			String slato=rs2.getString(11);
			if((freemem>0)&&(freemem<=tmem))
			{
				String query3="Select *from cloudpurchase where ('"+dt+"' between '"+slafrom+"' and '"+slato+"' )and downer='"+dname+"' "; 
				...
				if(rs.next())
				{
					...
					{
						%>
						<h3>Please <span class="style22">Wait For Cloud To Approve</span> Your  Purchase !</h3>
						<br />
						<%
					}
					...
					{
						%>
						<h3>Please Purchase Cloud To Continue..  !</h3>
						<br />
						<%
					}
				}
				...
				{
					%>
					<h3 class="style29">SLA Period Not Matching With Current Date <%--<a href="O_SLArequest.jsp">Click Here To Request..</a>--%> !!</h3>
					<%
				}
			}
			else
			{	
				//out.print("Free Memory :"+freemem);
				//out.print("Total Memory :"+tmem);
				%>
		...
		{
			%>
			<h3>You Have Not Purchased Space In Cloud </h3>
			<h3><a href="O_PurchaseCloud.jsp"> Click Here</a> To  Purchase ..  !</h3>
			<br />
			<%
		}
		connection.close();
