          ...
          <div class="post_content">
            ...
            <table width="631" border="1.5" style="border-collapse:collapse" cellpadding="0" cellspacing="0" align="left">
              <tr>
                ...
                <td width="112"><div align="center" class="style27">Data Owner </div></td>
                <td width="121"><div align="center" class="style27"><span class="style28">File Name </span></div></td>
	...
	while ( rs.next() )
	   {
		...
		%>
                <td><div>
                    <div align="center"><a href="C_ProvideDownPer1.jsp?usid=<%=i%>"><%=s5%></a></div>
                </div></td>
                <%
