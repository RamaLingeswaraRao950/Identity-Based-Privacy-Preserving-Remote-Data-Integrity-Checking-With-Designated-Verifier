...
.style4 {color: #353c3e}
.style5 {font-size: 14px; font-weight: bold; color: #353c3e; }
.style6 {color: #FF0000}
-->
</style>
</head>
...
<div class="main">
  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="active">
          <div class="article">
            <h2>Saved Memory </h2>
            <p class="infopost"><em><strong>Saved Memory Of The Data Owner After Sharing  File From Other User</strong></em></p>
            <p>&nbsp;</p>
            <table width="619" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0">
              <tr>
                <td width="55" height="31"><div align="center" class="style22 style4"> ID </div></td>
                <td width="123"><div align="center" class="style5">Shared File </div></td>
                <td width="195"><div align="center" class="style5">Shared File Owner </div></td>
                <td width="234"><div align="center" class="style5">Saved Memory</div></td>
              </tr>
              <%
      	...
      	try 
	{
      		...
      		String query="select * from shared_files "; 
	...
	while ( rs.next() )
	   {
		...
		%>
              <tr>
                ...
                <td><div align="center" class="style6">(<%=s3%>) saved <%=s7%></div></td>
              </tr>
              <%
	   }
      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><a href="D_MemSaved.jsp">Saved Memory</a> </li>
