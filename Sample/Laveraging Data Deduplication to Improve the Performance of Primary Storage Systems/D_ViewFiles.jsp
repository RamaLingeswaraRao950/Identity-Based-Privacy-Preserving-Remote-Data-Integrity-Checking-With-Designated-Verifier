      ...
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            ...
            <p class="infopost"><strong>Data owner files with shared (or)  verified status </strong></p>
            <p class="infopost">&nbsp;</p>
...
try 
	{		
              ...
              <tr>
                ...
                <td width="155"><div align="center" class="style21"><span class="style23">File Status </span></div></td>
              </tr>
              <%
              ...
              <tr>
				...
				{
				%><td><div align="center"><a href="D_S_Dedupp.jsp?fname=<%=s2%>">Not Verified</a></div></td><%
				}
				else if(s4.equalsIgnoreCase("Duplicate"))
				{
				%><td><div align="center"><a href="D_S_Dedupp.jsp?fname=<%=s2%>">Send Deduplication Details</a></div></td><%
				}
				else
				{
				%>
