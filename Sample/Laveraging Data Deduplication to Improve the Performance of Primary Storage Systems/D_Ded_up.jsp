  ...
  <div class="content style1">
    <div class="content_resize">
      <div class="mainbar">
        <div class="mainbar">
          <div class="article">
            <h2> Deduplication Tried and Uploaded </h2>
            <p class="infopost"><strong>Data owner Deduplication Tried And Uploaded Details </strong></p>
            <p class="infopost">&nbsp;</p>
            <table width="516" border="1.5" style="border-collapse:collapse" cellpadding="0" cellspacing="0"  align="center">
              <%	  
...
try 
	{		
				...
				%>
              <tr>
                <td width="54" height="30"><div align="center" class="style21"><span class="style23"> Id </span></div></td>
                <td width="138"><div align="center" class="style21"><span class="style23">Data Owner </span></div></td>
                <td width="153"><div align="center" class="style21"><span class="style23">Original File Name </span></div></td>
                <td width="161"><div align="center" class="style21"><span class="style23">Duplicate File Name </span></div></td>
              </tr>
              <%
				
				
				String query="Select *from deduplication_upload  "; 
              ...
              <tr>
                ...
                <td><div align="center"><%=s2%></a></div></td>
