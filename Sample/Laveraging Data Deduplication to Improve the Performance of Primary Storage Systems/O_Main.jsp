      ...
      <div class="sidebar">
        ...
        <div class="gadget">
          ...
          <ul class="sb_menu">
            ...
            <li><strong><a href="O_ViewFiles.jsp">View Files</a></strong></li>
            <li><strong><a href="O_Upload.jsp">Upload File</a></strong></li>
            <li><strong><a href="O_Update.jsp">Update File</a></strong></li>
            <li><strong><a href="O_PurchaseCloud.jsp">Purchase Cloud</a></strong></li>
            <li><strong><a href="O_De_dupDetails.jsp">Deduplication Details</a></strong></li>
