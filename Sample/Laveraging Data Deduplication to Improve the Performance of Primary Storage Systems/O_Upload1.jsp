...
<input type="hidden" name="fsize" value="<%=sourceFileSize %>" />
  <table width="560" border="0" align="center">
    ...
    <tr>
      <td height="40"><span class="style4 style22">MAC-1: </span></td>
    ...
    <tr>
      <td height="37"><span class="style4 style22">MAC-2: </span></td>
    ...
    <tr>
      <td height="41"><span class="style4 style22">MAC-3: </span></td>
    ...
    <tr>
      <td height="42"><span class="style4 style22">MAC-4: </span></td>
