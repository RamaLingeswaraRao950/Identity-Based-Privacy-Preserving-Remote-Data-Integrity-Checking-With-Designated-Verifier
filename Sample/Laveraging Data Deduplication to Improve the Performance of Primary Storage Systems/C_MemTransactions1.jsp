...
<div class="main">
  ...
  <div class="content style1">
      ...
      <div class="mainbar">
        <div class="article">
          ...
          <table width="565" border="2" cellpadding="0" style="border-collapse:collapse" cellspacing="0" align="center">
            <tr>
              <td width="45" height="31"><div align="center" class="style4"> ID </div></td>
              <td width="117"><div align="center" class="style4">User Name </div></td>
              <td width="109"><div align="center" class="style4">File Name </div></td>
              <td width="109"><div align="center" class="style4">Memory</div></td>
              <td width="116"><div align="center" class="style4">Task</div></td>
              <td width="164"><div align="center" class="style4">Date &amp; Time</div></td>
            </tr>
            <%
      	...
      	try 
	{
      		...
      		String query="select * from Transaction where (user='"+name+"'||fname='"+name+"') "; 
	...
	while ( rs.next() )
	   {
			...
			s5=rs.getString(4);
			s6=rs.getString(5);
			if(s4.equalsIgnoreCase(name))
			{
				%>
				<tr>
				<td height="29"><div align="center"><%=i%></div></td>
				<td><div align="center"><%=s4%></div></td>
				<td><div align="center" class="style6">----Cloud----</div></td>
				<td><div align="center" class="style6">----Assigned----</div></td>
				<td><div align="center" class="style6">----Memory----</div></td>
